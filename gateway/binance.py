...
class BinanceSpotHttp(object):
    ...
    def get_order_book(self, symbol, limit=5):
        ...
        path = "/api/v3/depth"
        query_dict = {"symbol": symbol.upper(),
                      "limit": limit
                      }
    ...
    def place_order(self, symbol: str, order_side: OrderSide, order_type: OrderType, quantity: float, price: float,
                    client_order_id: str = None, time_inforce="GTC", stop_price=0, quoteOrderQty=None, icebergQty=None):
        """
    ...
    def place_oco_order(self, symbol: str, order_side: OrderSide, quantity: float, price: float,
                        time_inforce="GTC", stop_price=0, stop_limit_price=0):
        """
        ...
        params = {
            ...
            "timestamp": self.get_current_timestamp(),
            "stopLimitTimeInForce":time_inforce
        }
    ...
    def get_all_order(self, symbol: str):
        ...
        prams = {"symbol": symbol.upper(), "timestamp": self.get_current_timestamp()}
    ...
    def get_order(self, symbol: str, client_order_id: str):
        ...
        """
        path = "/api/v3/order"
        prams = {"symbol": symbol.upper(), "timestamp": self.get_current_timestamp(), "origClientOrderId": client_order_id}

        return self.request(RequestMethod.GET, path, prams, verify=True)

    def get_order_by_id(self, symbol: str, orderId: int):
        """
        通过订单ID获取订单状态.
        :param symbol: 交易对
        :param orderId: 订单ID
        ...
        """
        path = "/api/v3/order"
        params = {"symbol": symbol.upper(), "timestamp": self.get_current_timestamp(), "orderId": orderId}
        return self.request(RequestMethod.GET, path, params, verify=True)

    def cancel_order_by_id(self, symbol: str, orderId: int):
        """
        通过订单ID取消订单.
        :param symbol: 交易对
        :param orderId: 订单ID
        ...
        for i in range(0, 3):
            try:
                ...
                print(f'cancel order by id error:{error}')
        return None
    ...
    def get_oco_order(self, orderListId):
        ...
        prams = {"timestamp": self.get_current_timestamp(), "orderListId": orderListId}
    ...
    def cancel_oco_order(self, symbol, orderListId):
        ...
        """
        path = "/api/v3/orderList"
        params = {"symbol": symbol.upper(), "timestamp": self.get_current_timestamp(),
